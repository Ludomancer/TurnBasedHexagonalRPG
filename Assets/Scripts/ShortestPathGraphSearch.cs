...
{
    class SearchNode<TState2, TAction2> : IComparable<SearchNode<TState2, TAction2>>
    {
    ...
    public List<TAction> GetShortestPath(TState fromState, TState toState)
    {
        ...
        SearchNode<TState, TAction> startNode = new SearchNode<TState, TAction>(null, 0, 0, fromState, _info.DefaultValue());
